...
test_that("df_typecast_list: typecasting by name works.", {
  ...
  expect_identical(res$a, c(6.1, 5.2, 3.2, 4.1, 5.2))
...
test_that("df_typecast_list.data.table: typecasting by name works.", {
  ...
  # check if internal selfref of data.table was preserved
  expect_equal(data.table:::selfrefok(res), 1)
  expect_equal(data.table:::selfrefok(res2), 1)
})




test_that("df_typecast_list.data.table: test conditions.", {
